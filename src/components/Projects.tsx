...
// Shopify Projects - Custom Shopify store development
const shopifyProjects = [
  {
    id: 1001,
    title: "TrendoraUK",
    description:
      "A modern UK-based Shopify pet store offering premium pet accessories, cozy beds, and grooming essentials. Designed and developed as a fully customizable Shopify theme tailored for my client’s needs — featuring custom sections, announcement sliders, and an optimized user experience for higher conversions.",
    techStack: [
      "Shopify",
      "Liquid",
      "HTML/CSS",
  ...
  },
  {
    ...
    description:
      "A premium Pakistani clothing brand specializing in men’s and women’s unstitched collections. Designed and developed as a fully customizable Shopify store for my fashion industry client — featuring bespoke theme sections, advanced WhatsApp integration, and a seamless, mobile-responsive design for best shopping experience.",
    techStack: [
      "Shopify",
      "Liquid",
      "HTML/CSS",
    ...
    image: "https://images.unsplash.com/photo-1758264839086-2bdecc06d9a3?q=80&w=435&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    liveDemo: "https://ikhwanunstitched.com",
    sourceCode: "",
  },
  {
    id: 1003,
    title: "GlamVision Cosmetics",
    description:
      "A modern Pakistani beauty and skincare brand developed as a fully customizable Shopify store for my client. Features elegant product showcases, custom theme sections, promotional banners, and a mobile-optimized layout ensuring a seamless shopping experience. Designed with a focus on brand storytelling and user engagement navigation.",
    techStack: [
      "Shopify",
      "Liquid",
      "HTML/CSS",
    ...
    image:
      "https://images.unsplash.com/photo-1691187861257-a56c4aa2d7fb?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    liveDemo: "https://kr1nr8-xp.myshopify.com/", // Replace with your Shopify preview link
    sourceCode: "",
  },
...
{
  id: 12,
  title: "SkillLoop – Skill Swap Platform",
  description:
    "A modern skill-sharing web app Frontend design where users teach what they know and learn in return, featuring authentication, skill search, profiles, messaging, and a scheduling calendar—all fully responsive.",
  techStack: [
    "React 18",
    "TypeScript",
    "Vite",
  ...
  image:
    "https://plus.unsplash.com/premium_photo-1661372012626-90b9e5001cea?q=80&w=885&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  liveDemo: "https://mughal-66.github.io/Skillloop-Skill-Swap/",
  sourceCode: "https://github.com/MUGHAL-66/Skillloop-Skill-Swap",
},
{
  id: 13,
  title: "GreenLedger – Carbon Tracking Platform",
  description:
    "A community-driven web app for tracking and reducing your carbon footprint. Users can join challenges, set goals, track activities, and see their environmental impact in real time. Fully responsive frontend built with React and Vite.",
  techStack: [
    "React 18",
    "TypeScript",
    "Vite",
  ...
  image:
    "https://plus.unsplash.com/premium_photo-1733317270278-772ee47c86d7?q=80&w=871&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Replace with actual screenshot URL
...
// Shopify Project Card Component (with Live View button only)
function ShopifyProjectCard({ project }: { project: any }) {
  return (
          ...
          <div className="space-y-8 luxury-slide-up">
            <div className="text-center space-y-4">
              ...
              <p className="text-white/50 max-w-2xl mx-auto">
                Custom Shopify store development featuring premium themes, custom sections, and optimized e-commerce experiences
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {shopifyProjects.map((project, index) => (
                ...
                >
                  <ShopifyProjectCard project={project} />
                </div>
              ))}
            </div>
          </div>
